...
EXAMPLE_QUERIES: dict[str, list[dict[str, str]]] = {
    ...
    "aggregation": [
        ...
        {
            "query": "| stats count, avg(ti_score) by severity",
            "description": "Multiple aggregations",
        },
        {
            "query": "| stats dc(src_ip) as unique_sources by event_type",
            "description": "Distinct count with alias",
        },
    ...
    "time_analysis": [
        {
            "query": "earliest=-1h | timechart span=5m count",
            "description": "Events per 5 minutes (last hour)",
        },
        {
            "query": "earliest=-7d | timechart span=1d count by severity",
            "description": "Daily events by severity",
        },
    ...
    "enrichment": [
        ...
        {
            "query": '| eval risk = if(severity = "high", 100, 50)',
    ...
    "threat_hunting": [
        ...
        {
            "query": "ti_score > 70 | table ts, src_ip, dst_ip, ti_tags, message",
            "description": "High threat intel",
        },
        {
            "query": "| stats dc(dst_ip) by src_ip | where dc_dst_ip > 10",
            "description": "Port scanning",
        },
        {
            "query": "| transaction src_ip maxspan=5m | where event_count > 20",
            "description": "Activity bursts",
        },
    ],
}
