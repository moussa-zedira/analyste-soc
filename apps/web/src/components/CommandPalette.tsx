...
const NAV_PAGES = [
  ...
  { href: "/pentest/deep", label: "Scan Profond" },
  { href: "/pentest", label: "Pentest Lab" },
  { href: "/pentest/pipeline", label: "Pipeline Auto" },
  { href: "/pentest/history", label: "Scan History" },
  { href: "/pentest/docs", label: "Pentest Docs" },
  { href: "/pentest/sessions", label: "Sessions" },
  { href: "/pentest/nvd", label: "CVE Search" },
  { href: "/pentest/templates", label: "Templates" },
  { href: "/pentest/hash", label: "Hash Cracker" },
  { href: "/pentest/report", label: "Rapport Pro" },
  { href: "/pentest/wordgen", label: "Wordlist Gen" },
  { href: "/pentest/network", label: "Evasion Reseau" },
  { href: "/pentest/blind", label: "Blind Extract" },
  { href: "/pentest/oob", label: "OOB Callback" },
  { href: "/pentest/ssrf", label: "SSRF Avance" },
  { href: "/pentest/subdomain", label: "Sous-domaines" },
  { href: "/pentest/waf-bypass", label: "WAF Bypass" },
  { href: "/pentest/exfil", label: "Exfiltration" },
  { href: "/pentest/persist", label: "Persistence" },
  { href: "/pentest/antiforensics", label: "Anti-Forensics" },
  { href: "/pentest/killchain", label: "Kill Chain" },
  { href: "/pentest/shell", label: "Shell Handler" },
  { href: "/pentest/chain", label: "Attack Chain" },
  { href: "/pentest/sqli", label: "SQLi Engine" },
  { href: "/pentest/xss-engine", label: "XSS Engine" },
  { href: "/pentest/lfi-rce", label: "LFI to RCE" },
  { href: "/pentest/privesc", label: "Privesc" },
  { href: "/pentest/creds", label: "Cred Harvester" },
  { href: "/pentest/lateral", label: "Lateral Move" },
  { href: "/pentest/protocols", label: "Protocols" },
  { href: "/pentest/bridge", label: "Exec Bridge" },
  { href: "/pentest/c2", label: "C2 Server" },
  { href: "/pentest/proxy", label: "HTTP Proxy" },
  { href: "/pentest/evasion", label: "AV Evasion" },
  { href: "/pentest/fuzzer", label: "Fuzzer" },
  { href: "/pentest/netscan", label: "Net Scanner" },
  { href: "/pentest/exploit-dev", label: "Exploit Dev" },
  { href: "/pentest/ai", label: "AI Assistant" },
  { href: "/pentest/workflows", label: "Workflows" },
    ...
    () => [
      {
        ...
        description: "Start or stop the real-time event stream",
        action: () => router.push("/pentest/live"),
      },
      {
        id: "action-run-analysis",
        label: "Run Analysis",
        description: "Launch a new security scan analysis",
